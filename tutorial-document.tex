...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, titlerule=0mm, left=2mm, colback=white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacityback=0, breakable]
