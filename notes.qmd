...
Well, for the last project meeting, I had a naïve question about whether we could formulate a Lagrangian for the drying scenario. For example, in my supervisors' papers, they couldn't manage to observe the drying transition in their setup. So, I was asking if, when the trajectory of all particles is away from the surface, we could possibly derive an analytical equation of forces between the particles and the wall to induce torque. Just a pure naïve idea.

Nigel said the principle of least action makes sense in equilibrium settings, so I had to revise that concept. The Lagrangian is the kinetic energy minus potential energy, whatever this quantity is. In non-equilibrium systems, energy keeps changing since active agents continuously consume energy. Also, the effective potential depends on the properties of the wall. So, the Lagrangian would become time-dependent, which now makes sense based on what Nigel said.
...
This is beautiful: conserved quantities defirve from symmetries of the system. It also implies that since energy is *not* conserved for the system of my interest, the equations of motion would be time-dependent. I think it would be useful to pay attention to how the equations of motion for active Brownian particles are formulated once I revise their papers.

In terms of his lectures, I think I'll continue to watch part 3 since I've already watched the first two. Though, I think his lecture notes were better than his recorded video lectures from what I remember, even if his video lectures on the physics of phase transitions were much more inspiring. So, a note for my future self: when revising the content of the analytical formulation of mechanics, read his lecture notes.
...
3. syncs the video and audio together seamlessly to create an mp4 file,
4. keeps the system active throughout the process by using caffeinate to prevent the computer from going to sleep,
5. tracks and reports the download status, ensuring that any interrupted downloads are handled smoothly,
...
- I'm lazy to log in to Blackboard (the university website) every time I want to watch videos.
- I personally wanted to collect the lectures before they disappear from the website.
- There are a lot of pauses in the lectures where the lecturer doesn't speak while writing equations. Removing these pauses also saves total viewing time. Observe the difference:
...
The buffer is necessary, as it makes the transitions feel more natural by introducing a brief pause rather than cutting the silences completely. Watch an example below:
